...
function solve_wing_CF_CM(aircraft, parameters, freestream, environment, step_range, stepi, step_symbol)
    ...
    VL.steady_analysis!(aircraft.wing_system.system, aircraft.wing_system.system.surfaces, aircraft.wing_system.system.reference[1], vlmfreestream; symmetric=true, additional_velocity = parameters.wake_function[stepi])

    # extract forces and moments
    CF, CM = VL.body_forces(aircraft.wing_system.system; frame=VL.Wind())
